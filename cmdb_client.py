...
_SEED_ASSETS = [
    (1, "172.17.0.6", "target-apache", "Linux", "Web Server",   "dev", "high",   "Arnav",  "arnav@example.com",  "WebOps"),
    (2, "172.17.0.5", "target-mysql",  "Linux", "Database",     "dev", "high",   "Arnav",   "arnav@example.com",    "DataOps"),
    (3, "172.17.0.4", "target-php",    "Linux", "App Server",   "dev", "medium", "Dhivyan",  "dhivyan@example.com",  "AppDev"),
    (4, "172.17.0.3", "target-redis",  "Linux", "Cache Server", "dev", "medium", "Dhivyan", "dhivyan@example.com",   "AppDev"),
]
